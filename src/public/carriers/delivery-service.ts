import type { Country, Definition, DefinitionIdentifier, DeliveryConfirmationType } from "../common";
...
import type { PackagingDefinition } from "./packaging";
...
export interface DeliveryServiceDefinition extends Definition {
   ...
   */
  deliveryConfirmations?: DeliveryConfirmationType;
}
